...
function onBotVoiceStateUpdate(oldMember, newMember) {
    ...
    try {
        ...
        if (newMember && newMember.voiceChannel &&
            (newMember.voiceChannel.id === '332567530025779200' ||
                newMember.voiceChannel.id === '262834612932182026' ||
...
function handleDM(msg) {
    ...
    if (dmLog[msg.author.username] === undefined) {
        ...
        dmLog[msg.author.username] = {
            user_id: msg.author ? msg.author.id : -1,
            message_id: msg.id,
